...
export type AllSanitySchemaTypes = Event | SanityImageCrop | SanityImageHotspot | Artist | Venue | Slug | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
